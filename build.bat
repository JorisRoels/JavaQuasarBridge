...
javac -d output\class java\src\be\vib\bits\Test.java java\src\be\vib\bits\Example1.java java\src\be\vib\bits\QTypeBuilder.java java\src\be\vib\bits\QHost.java java\src\be\vib\bits\QUtils.java java\src\be\vib\bits\QValue.java java\src\be\vib\bits\QFunction.java java\src\be\vib\bits\QMethod.java java\src\be\vib\bits\QType.java java\src\be\vib\bits\QRange.java java\src\be\vib\bits\QNativePointer.java
...
cl /Zi /W3 /LD /EHsc /D_CRT_SECURE_NO_WARNINGS cpp\WideString.cpp cpp\QTypeBuilderJNI.cpp cpp\Utils.cpp cpp\QUtilsJNI.cpp cpp\QHostJNI.cpp cpp\QValueJNI.cpp cpp\QFunctionJNI.cpp cpp\QTypeJNI.cpp cpp\QMethodJNI.cpp cpp\QRangeJNI.cpp "%MY_QUASAR%\include\quasar_dsl.cpp" "%MY_QUASAR%\include\quasar_host.cpp" /I"E:\Program Files\Java\jdk1.8.0_92\include\win32" /I"e:\Program Files\Java\jdk1.8.0_92\include" /Ioutput\include /I"%MY_QUASAR%\include" /Fooutput\ /Feoutput\JavaQuasarBridge.dll
